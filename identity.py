...
def createIdentities():
	...
	identities[2] = {'Gender': 'male', 'Age': '39', 'Marriage': 'Single', 'First_name': 'Leo', 'Last_name': 'Brookes', 'Occupation': 'a store owner', 'Address': '11 Lordswood Road', 'City': 'Birmingham', 'Country':'England','Postcode': 'B17 9RP', 'Telephone':'07851832724', 'Email': 'leobrooks31@yahoo.co.uk', 'POP3': 'pop.mail.yahoo.com', 'SMTP': 'smtp.mail.yahoo.com', 'Username': 'leobrooks31@yahoo.co.uk', 'Password': 'leo12321d9'}
